...
exports.mostDeliveredLocation = async (req, res) => {
    return await Logistics.findOne({
        attributes: ['c_deliveryAddress_area', [sequelize.fn('COUNT', sequelize.col('c_deliveryAddress_area')), 'total']],
        raw: true,
        group: 'c_deliveryAddress_area', order: [[sequelize.fn('COUNT', sequelize.col('c_deliveryAddress_area')), 'DESC']]
    });
}
