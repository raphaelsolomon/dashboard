...
route.post('/', async (req, res) => {
    ...
    payload['control_substances'] = {
        where_not_locked: req.body['Statutory_Compliance[control_substances][where_not_locked]'],
        yes_how_frequently: req.body['Statutory_Compliance[control_substances][if_sighted]'],
        if_sighted1: req.body['Statutory_Compliance[control_substances][if_sighted1]'],
    };
