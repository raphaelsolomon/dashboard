...
const { AuditBankAudit, AuditWelFare, AuditControlSubstance, AuditEmergencyProceedure, AuditExecutiveSummary, AuditIncident } = require("../../model/audit/lifting_opt.model");
...
route.post('/submission', isAuthenticated, async (req, res) => {
    ...
    AuditIncident.create(result.incident);
