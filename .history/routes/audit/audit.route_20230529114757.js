...
const { AuditBankAudit, AuditWelFare, AuditControlSubstance, AuditEmergencyProceedure, AuditExecutiveSummary, AuditIncident, AuditLadder, AuditLiftOpt, AuditReportInjuries, AuditMgtReviews } = require("../../model/audit/lifting_opt.model");
const { AuditTraining, AuditSafetySystem, AuditCommunication, AuditContractorsMgt } = require("../../model/audit/training.model");
...
route.post('/submission', isAuthenticated, async (req, res) => {
    ...
    AuditLadder
    AuditLiftOpt
    AuditReportInjuries.create(result.)
