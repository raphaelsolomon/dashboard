...
const { AuditBankAudit, AuditWelFare, AuditControlSubstance, AuditEmergencyProceedure } = require("../../model/audit/lifting_opt.model");
...
route.post('/submission', isAuthenticated, async (req, res) => {
    ...
    AuditEmergencyProceedure.create(result.emergency_proceed)
