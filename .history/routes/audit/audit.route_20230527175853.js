...
route.post('/', async (req, res) => {
    ...
    payload['Electricity'] = {
        where_not_locked: req.body['Statutory_Compliance[Electricity][safety_signs_placed_differentiate_male_female_toilets]'],
        if_sighted: req.body['Statutory_Compliance[Electricity][safety_signage_promoting_personal_hygiene_toilet]'],
        if_sighted1: req.body['Statutory_Compliance[Electricity][workers_provided_cloak-_rooms/lockers]'],
        if_sighted2: req.body['Statutory_Compliance[Electricity][toilets_good_usable_conditions]'],
        last_review_date_fire_risk_assessment: req.body['Statutory_Compliance[Electricity][male_female_toilets_provided]'],
        electrical_distribution_boxes_securely_locked: req.body['Statutory_Compliance[Electricity][descirbe_sign]'],
        sight_any_trailing_cables: req.body['Statutory_Compliance[Electricity][if_no_which_toilet]'],
        sight_any_exposed_naked_wires: req.body['Statutory_Compliance[Electricity][toilets_good_usable_conditions]'],
        faulty_sockets_switches: req.body['Statutory_Compliance[Electricity][male_female_toilets_provided]'],
        fire_risk_assessment: req.body['Statutory_Compliance[Electricity][descirbe_sign]'],
        procedure_monitoring_electrical_appliances: req.body['Statutory_Compliance[Electricity][if_no_which_toilet]'],
    };
