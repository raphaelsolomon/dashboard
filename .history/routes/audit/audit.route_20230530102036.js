...
const { AuditTemperatures, AuditStairCases, AuditSafetySigns, AuditAccessExits, AuditFirePrecautions, AuditGangWays, AuditFloors, AuditLightenings } = require("../../model/audit/environment.model");
...
route.post('/submission', isAuthenticated, async (req, res) => {
    ...
    await AuditLightenings.create(result.lights);
    await AuditH
...
route.get('/table3', isAuthenticated, async (req, res) => {
    ...
    res.status(200).render('../audit/table/sectionTable3', { alert: [], temperature: temperature, fire_precaution: fire_precautions, access_exit: access_exit, 
