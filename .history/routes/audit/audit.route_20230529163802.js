...
route.get('/section/table2', isAuthenticated, async (req, res) => {
    ...
    const lifting = await AuditLiftOpt.find
    res.status(200).render('../audit/table/sectionTable2', { alert: [], injuries: injuries, first_aid: first_aid, first_safety: first_safety });
});
