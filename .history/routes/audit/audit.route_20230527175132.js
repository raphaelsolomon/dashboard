...
route.post('/', async (req, res) => {
    payload['Welfare'] = {
        safety_signage_promoting_personal_hygiene_toilet: req.body['welfare_facilities[Welfare][workers_provided_cloak-_rooms/lockers]'],
        workers_provided_cloak-_rooms_lockers: req.body['welfare_facilities[Welfare][workers_provided_cloak-_rooms/lockers]'],
    }
    console.log();
    res.status(200).json('');
});
