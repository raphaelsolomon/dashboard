...
const { AuditBankAudit, AuditWelFare, AuditControlSubstance, AuditEmergencyProceedure, AuditExecutiveSummary } = require("../../model/audit/lifting_opt.model");
...
route.post('/submission', isAuthenticated, async (req, res) => {
    ...
    AuditFirstSafety.create();
    AuditExecutiveSummary.create
