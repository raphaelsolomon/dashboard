...
const { AuditBankAudit, AuditWelFare, AuditControlSubstance, AuditEmergencyProceedure, AuditExecutiveSummary, AuditIncident, AuditLadder, AuditLiftOpt, AuditReportInjuries, AuditMgtReviews, AuditSafetyPolicy, AuditHandTools, AuditInsurance } = require("../../model/audit/lifting_opt.model");
...
route.get('/', isAuthenticated, async (req, res) => {
    ...
    res.status(200).render('../audit/index', { alert: [], user: user });
});
...
route.get('/table1', isAuthenticated, async (req, res) => {
    ...
    res.status(200).render('../audit/table/sectionTable1', { alert: [], mgtsReviews: mgtsReviews, insurance: insurance, emgProceedure: emgProceedure, auditSafetyPolic: auditSafetyPolic, incident: incident,  wasteMgts: wasteMgts,
...
route.get('/table2', isAuthenticated, async (req, res) => {
    ...
    res.status(200).render('../audit/table/sectionTable2', { alert: [], injuries: injuries, first_aid: first_aid, first_safety: first_safety, lifting: lifting, control_substances: control_substances, electric: electric, user: user });
});
...
route.get('/table4', isAuthenticated, async (req, res) => {
    ...
    res.status(200).render('../audit/table/sectionTable4', { alert: [], ladder: ladder, handtools: handtools, user:  });
});
