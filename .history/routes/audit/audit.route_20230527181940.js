...
route.post('/', async (req, res) => {
    ...
    payload['lifting_operations'] = {
        ...
        sight_any_lifting_equipment: req.body['Statutory_Compliance[lifting_operations][reporting_injuries_regulatory_body]'],
        section: 'Statutory_Compliance'
    };
    payload['reporting_injuries'] = {
        ...
        reporting_injuries_regulatory_body: req.body['Statutory_Compliance[lifting_operations][sight_any_lifting_equipment]'],
        section: 'Statutory_Compliance'
    };
