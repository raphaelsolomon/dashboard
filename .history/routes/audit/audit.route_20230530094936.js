...
const { AuditTemperatures, AuditStairCases, AuditSafetySigns, AuditAccessExits, AuditFirePrecautions } = require("../../model/audit/environment.model");
...
route.post('/submission', isAuthenticated, async (req, res) => {
    ...
    await AuditFirePrecautions.create(result.temperature);
    await AuditTemperatures.create(result.temperature);
