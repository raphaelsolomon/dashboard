...
route.post('/', async (req, res) => {
    ...
    //================================ENVRIONMENT COMPLETED=====================================================
    payload['temperature'] = {
        safety_signs_placed_differentiate_male_female_toilets: req.body['welfare_facilities[temperature][safety_signs_placed_differentiate_male_female_toilets]'],
        section: 'Environment'
    };
