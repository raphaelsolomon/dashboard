...
route.post('/', async (req, res) => {
    ...
    payload['safe_system'] = {
        ...
        updated_safety_risk_assessment_toolbox_conducted_facility_contractorsfacility: req.body['Administration_Procedure[safe_system][toolbox_conducted_facility_contractors]'],
        updated_safety_risk_assessment_facility: req.body['Administration_Procedure[safe_system][updated_safety_risk_assessment_facility]'],
        updated_safety_risk_assessment_facility: req.body['Administration_Procedure[safe_system][updated_safety_risk_assessment_facility]'],
        updated_safety_risk_assessment_facility: req.body['Administration_Procedure[safe_system][updated_safety_risk_assessment_facility]'],
        section: 'administration_procedure'
