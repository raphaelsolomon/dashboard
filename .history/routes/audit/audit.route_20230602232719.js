...
route.post('/submission', isAuthenticated, async (req, res) => {
    ...
    result['images'].safety_signs = req.body['path[workstations]'] === undefined ?'': req.body['path[workstations]'];
    result['images'].workstations = req.body['path[poor_house_keeping]'] === undefined ?'': req.body['path[poor_house_keeping]'];
    result['images'].toilets = req.body['path[poor_house_keeping]'] === undefined ?'': req.body['path[poor_house_keeping]'];
