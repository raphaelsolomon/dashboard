...
route.post('/', async (req, res) => {
    ...
    payload['ladders'] = {
        monitor_screens_brightness_moderate: req.body['Statutory_Compliance[ladders][monitor_screens_brightness_moderate]'],
        yes_how_frequently: req.body['Statutory_Compliance[ladders][yes_how_frequently]'],
    };
