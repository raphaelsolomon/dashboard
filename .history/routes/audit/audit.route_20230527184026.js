...
route.post('/', async (req, res) => {
    ...
    payload['incident_accident'] = {
        ...
        regulatory_agencies_occupational_incidents/accidents_reported_to: req.body['Administration_Procedure[incident_accident][regulatory_agencies_occupational_incidents/accidents_reported_to]'],
        last_review_date: req.body['Administration_Procedure[incident_accident][last_review_date]'],
        last_review_date: req.body['Administration_Procedure[incident_accident][last_review_date]'],
        section: 'administration_procedure'
    };
