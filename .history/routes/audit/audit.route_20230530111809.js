...
route.get('/table1', isAuthenticated, async (req, res) => {
    ...
    res.status(200).render('../audit/table/sectionTable1', { alert: [], mgtsReviews: mgtsReviews, insurance: insurance, emgProceedure: emgProceedure, auditSafetyPolic: auditSafetyPolic, incident: incident,  });
});
