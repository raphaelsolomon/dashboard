...
route.post('/', async (req, res) => {
    ...
    payload['communication'] = {
        ...
        safety_communication_bank: req.body['Administration_Procedure[communication][safety_communication_bank]'],
        safety_communication_bank: req.body['Administration_Procedure[communication][safety_communication_bank]'],safety_communication_bank: req.body['Administration_Procedure[communication][safety_communication_bank]'],
        section: 'administration_procedure'
    };
