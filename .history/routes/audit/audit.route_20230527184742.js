...
route.post('/', async (req, res) => {
    ...
    payload['permit_work'] = {
        ...
        permit_to_work_process_contractor: req.body['Administration_Procedure[permit_work][last_review_date]'],
        last_review_date: req.body['Administration_Procedure[permit_work][last_review_date]'],
        last_review_date: req.body['Administration_Procedure[permit_work][last_review_date]'],
        section: 'administration_procedure'
    };
