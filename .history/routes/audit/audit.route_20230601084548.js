...
route.get('/introduction', isAuthenticated, async (req, res) => {
    ...
    res.status(200).render('../audit/table/introdction', { alert: [], welfare: welfare, user: user, bank_audit: bank_audit, executive_summary: executive_summary});
});
