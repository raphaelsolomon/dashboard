...
route.get('/general', isAuthenticated, async (req, res, next) => {
  return res.status(200).render('../inputs/general_input', { alert: [] });
})

route.get('/overview', isAuthenticated, async (req, res, next) => {
  return res.status(200).render('..//inputs/incident_overview_input', { alert: [] });
})

route.get('/hse_inspection', isAuthenticated, async (req, res, next) => {
  return res.status(200).render('../inputs/hse_inpsection_report_input', { alert: [] });
})
...
route.get('/external', isAuthenticated, async (req, res, next) => {
  return res.status(200).render('../inputs/external_audit_inspection_input', { alert: [] });
})

route.get('/hse_onduty', isAuthenticated, async (req, res, next) => {
  return res.status(200).render('../inputs/hse_personnel_onduty_input', { alert: [] });
})

route.get('/others', isAuthenticated, async (req, res, next) => {
  return res.status(200).render('../inputs/other_hse_activities_input', { alert: [] });
})

route.get('/water_and_oil', isAuthenticated, async (req, res, next) => {
  return res.status(200).render('../inputs/water_and_oil_record_input', { alert: [] });
})
...
route.post('/general', isAuthenticated, async (req, res, next) => {
  if (req.body.date === undefined) {
    ...
    return res.status(200).render('../inputs/general_input', { alert: msg });
  }
...
route.post('/hse_inspection', isAuthenticated, async (req, res, next) => {
  if (req.body.date === undefined) {
    const msg = [];
    msg.push({ msg: `All fields are empty`, err: true });
    return res.status(200).render('../inputs/hse_inpsection_report_input', { alert: msg });
  }
...
route.post('/contractor', isAuthenticated, async (req, res, next) => {
  if (req.body.date === undefined) {
    const msg = [];
    msg.push({ msg: `All fields are empty`, err: true });
    return res.status(200).render('../inputs/contractor_management_input', { alert: msg });
  }
...
route.post('/external', isAuthenticated, async (req, res, next) => {
  if (req.body.date === undefined) {
    const msg = [];
    msg.push({ msg: `All fields are empty`, err: true });
    return res.status(200).render('../inputs/external_audit_inspection_input', { alert: msg });
  }
...
route.post('/hse_onduty', isAuthenticated, async (req, res, next) => {
  if (req.body.date === undefined) {
    const msg = [];
    msg.push({ msg: `All fields are empty`, err: true });
    return res.status(200).render('../inputs/hse_personnel_onduty_input', { alert: msg });
  }
