...
route.post('/search', (req, res, next) => {
    ...
    if (req.user.trade === "Plastics") {
        Plastic.findAll({ where: {
            [Op.or] : [{product: search}, {manufacturer: search}, {initial_content: search}, {zone: search}, {retrieved_from: search}, {plastic_size: search}, {tonnage: search}, {volume_of_plastics: search}, {date},]
        } }).then((plastic) => {
