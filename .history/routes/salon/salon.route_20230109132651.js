...
route.post('/', (req, res) => {
    ...
    req.brand_powder = `${brand_powder}`;
    req.brand_equipment_used = `${brand_equipment_used}`;
    req.brand_cream_used = `${brand_cream_used}`;
    req.brand_clipper_used = `${brand_clipper_used}`;
    req.brand_extension_used = `${brand_extension_used}`;
    req.brand_relaxer_used = `${brand_relaxer_used}`;
    ...
    console.log(JSON.stringify(brand_powder));
