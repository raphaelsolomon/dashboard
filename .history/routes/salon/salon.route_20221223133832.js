...
const { firstPage, openingClosing, staffNumbers, officeInCharge, brandExtensionUsed } = require("../../chartQuery/salon.query");
...
route.get('/chart', async (req, res) => {
    ...
    const brandCream = await 
    res.status(200).render('../salon/analysis', { firstPage: firstpage, timing: timing, staffs: staffNums, officer: officers, brandExtension: brandExtension });
});
