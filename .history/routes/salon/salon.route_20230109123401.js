...
route.post('/', (req, res) => {
    ...
    const { monday, tuesday, wednesday, thursday, friday, saturday, sunday, brand_extension_used, brand_powder, brand_equipment_used, brand_cream_used, brand_clipper_used} = req.body;
    //============================================================================
    if (monday === 'on') {
        days.push('Monday');
    }
    ...
    req.brand_powder = `${brand_powder}`.split(', ')
    req.brand_equipment_used = `${brand_equipment_used}`.split(', ')
    req.brand_cream_used = `${brand_cream_used}`.split(', ');
    req.brand_clipper_used = `${brand_clipper_used}`.split(', ')
    req.brand_extension_used = `${brand_extension_used}`.split(', ');
