...
route.post('/', (req, res) => {
    ...
    req.brand_powder = JSON.stringify(brand_powder).join(', ');
    req.brand_equipment_used = brand_equipment_used.join(', ');
    req.brand_cream_used = brand_cream_used.join(', ');
    req.brand_clipper_used = brand_clipper_used.join(', ');
    req.brand_extension_used = brand_extension_used.join(', ');
    req.brand_relaxer_used = brand_relaxer_used.join(', ');
