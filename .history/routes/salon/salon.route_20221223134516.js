...
const { firstPage, openingClosing, staffNumbers, officeInCharge, brandExtensionUsed, brandCreamUsed } = require("../../chartQuery/salon.query");
...
route.get('/chart', async (req, res) => {
    ...
    res.status(200).render('../salon/analysis', { firstPage: firstpage, timing: timing, staffs: staffNums, officer: officers, brandExtension: brandExtension, brandCream: brandCream, isAc: isAc });
});
