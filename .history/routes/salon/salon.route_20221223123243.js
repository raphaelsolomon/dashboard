...
const { firstPage, openingClosing } = require("../../chartQuery/salon.query");
...
route.get('/chart', async (req, res) => {
    ...
    const timing = openingClosing();
    const staffNumbers = staffNumbers();
    res.status(200).render('../salon/analysis', { firstPage: firstpage, timing: timing, staffNumbers:  });
});
