...
const { firstPage, openingClosing, staffNumbers, officeInCharge, brandExtensionUsed, brandCreamUsed, isAirconditioner } = require("../../chartQuery/salon.query");
...
route.get('/chart', async (req, res) => {
    ...
    const brandClipperUsed
    res.status(200).render('../salon/analysis', { firstPage: firstpage, timing: timing, staffs: staffNums, 
        officer: officers, brandExtension: brandExtension, brandCream: brandCream, isAc: isAc });
});
