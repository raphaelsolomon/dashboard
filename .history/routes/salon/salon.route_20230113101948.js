...
route.post('/', (req, res) => {
    ...
    req.body.brand_clipper_used =  brand_cream_used === undefined? '':`${brand_clipper_used}`;
    req.body.brand_extension_used =  brand_cream_used === undefined? '':`${brand_extension_used}`;
