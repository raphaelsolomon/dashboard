...
const { firstPage, openingClosing, staffNumbers, officeInCharge, brandExtensionUsed, brandCreamUsed, isAirconditioner, brandClipperUsed, brandEquipmentUsed, brandRelaxerUsed } = require("../../chartQuery/salon.query");
...
route.get('/chart', async (req, res) => {
    ...
    const operationalDays = await operationalDaysUsed();
    res.status(200).render('../salon/analysis', { firstPage: firstpage, timing: timing, staffs: staffNums, equipment: equipment,
