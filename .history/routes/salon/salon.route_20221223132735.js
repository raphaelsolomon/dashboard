...
const { firstPage, openingClosing, staffNumbers, officeInCharge } = require("../../chartQuery/salon.query");
...
route.get('/chart', async (req, res) => {
    ...
    const brandExtensionUsed
    res.status(200).render('../salon/analysis', { firstPage: firstpage, timing: timing, staffs: staffNums, officer: officers });
});
