...
route.post('/search', (req, res, next) => {
    ...
    if (req.user.trade === "Plastics") {
        return Plastic.findAll({ where: {
            [Op.or] : [{product: {
                [Op.like]: `${myFunctionSelect}`
            }}, {manufacturer: search}, {initial_content: search}, {zone: search}, {retrieved_from: search}, {plastic_size: search}, {tonnage: search}, {volume_of_plastics: search}, {date:  search}]
        } }).then((plastic) => {
