...
route.get("/recent/:id", isAuthenticated, async (req, res, next) => {
  ...
  if (req.user.trade === "Plastics") {
    return require("../controller/plastic.controller").recentId;
  }
  if (req.user.trade === "Commodity") {
...
route.get("/add", isAuthenticated, (req, res, next) => {
  if (req.user.trade === "Logistics") {
    return require("../controller/logistic.controller").addItem;
  }
  if (req.user.trade === "Plastics") {
    return require("../controller/plastic.controller").addItem;
  }
  if (req.user.trade === "Commodity") {
    return require("../controller/commodity.controller").addItem;
  }
  if (req.user.trade === "Wemabod") {
    return require("../controller/wemabod.controller").addItem;
  }
});
...
route.get("/table", isAuthenticated, async (req, res, next) => {
  ...
  if (req.user.trade === "Plastics") {
    return require("../controller/plastic.controller").getTable;
  }
  if (req.user.trade === "Wemabod") {
    return require("../controller/wemabod.controller").getTable;
  }
  if (req.user.trade === "Commodity") {
...
route.get("/sort", isAuthenticated, async (req, res, next) => {
  if (req.user.trade === "Plastics") {
    return require("../controller/plastic.controller").getSorts;
  }
});
...
route.get("/sort-table", isAuthenticated, async (req, res) => {
  if (req.user.trade === "Plastics") {
    return require("../controller/plastic.controller").getSortTables;
  }
});

route.get("/sortEdit", isAuthenticated, async (req, res) => {
  if (req.user.trade === "Plastics") {
    return require("../controller/plastic.controller").editSort;
  }
});
...
route.post('/sort-update', isAuthenticated, (req, res) => {
  return require('../controller/plastic.controller').updateSort;
})
...
route.get("/details", isAuthenticated, async (req, res, next) => {
  if (req.user.trade === "Logistics") {
    return require("../controller/logistic.controller").getEdit;
  }
  if (req.user.trade === "Plastics") {
    return require("../controller/plastic.controller").getEdit;
  }
  if (req.user.trade === "Wemabod") {
    return require("../controller/wemabod.controller").getEdit;
  }
  if (req.user.trade === "Commodity") {
    return require("../controller/commodity.controller").getEdit;
  }
});

route.post("/details/:id", isAuthenticated, async (req, res, next) => {
  if (req.user.trade === "Logistics") {
    return require("../controller/logistic.controller").update;
  }
  if (req.user.trade === "Plastics") {
    return require("../controller/plastic.controller").update;
  }
  if (req.user.trade === "Wemabod") {
    return require("../controller/wemabod.controller").update;
  }
  if (req.user.trade === "Commodity") {
    return require("../controller/commodity.controller").update;
  }
});

route.get('/daily', isAuthenticated, async (req, res) => {
  return require("../controller/admin.plastic.controller").getTable;
});

route.get('/brand', isAuthenticated, async (req, res) => {
  return require("../controller/admin.plastic.controller").getBrand;
});

route.get('/total', isAuthenticated, async (req, res) => {
  return require("../controller/admin.plastic.controller").getTotal;
});

route.get('/cap', isAuthenticated, async (req, res) => {
  return require("../controller/admin.plastic.controller").getCaps;
});

route.get('/color', isAuthenticated, async (req, res) => {
  return require("../controller/admin.plastic.controller").getColors;
});

route.get('/label', isAuthenticated, async (req, res) => {
  return require("../controller/admin.plastic.controller").getLabel;
});
