...
route.get("/details/:id", isAuthenticated, async (req, res, next) => {
  if (req.user.trade === "Logistics") {
    return require("../controller/logistic.controller").getTable(req, res);
  }
  if (req.user.trade === "Plastics") {
    return require("../controller/plastic.controller").getTable(req, res);
  }
  if (req.user.trade === "Wemabod") {
    return require("../controller/wemabod.controller").getTable(req, res);
  }
  if (req.user.trade === "Commodity") {
    return require("../controller/commodity.controller").getTable(req, res);
  }
