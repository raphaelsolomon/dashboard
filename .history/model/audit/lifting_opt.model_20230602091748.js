...
const AuditControlSubstance = sequelize.define('audit_control_substances', {
    id: {
        type: Sequelize.UUID,
        defaultValue: Sequelize.UUIDV4,
        allowNull: false,
    ...
    harmful_sub_stored_in_facility: {
        type: Sequelize.TEXT,
    },
    cleaning_item_stored_safely_within: {
        type: Sequelize.TEXT
    },
    did_cleaner_use_personal_protective_equip: {
        type: Sequelize.TEXT
    },
    generator_free_of_oil_spillage: {
        type: Sequelize.TEXT,
    },
