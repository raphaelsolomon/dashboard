...
const AuditTraining = sequelize.define('audit_trainings', {
    id: {
        type: Sequelize.UUID,
...
const AuditContractorsMgt = sequelize.define('audit_contractors_managements', {
    ...
    sight_contractor_adequate_ppe_audit: {
        type: Sequelize.TEXT,
    },
    documented_contractor_safety_policy_place: {
        type: Sequelize.TEXT,
    },
    section: {
        type: Sequelize.TEXT,
...
module.exports = { AuditTraining, AuditPermitWork, AuditSafetySystem, AuditCommunication, AuditContractorsMgt };