...
//`SELECT DISTINCT(*) FROM users where createdAt BETWEEN '${getPreviousDay().toISOString().substring(0, getPreviousDay().toISOString().indexOf('T'))} 00:00:00' AND '${date.toISOString().substring(0, date.toISOString().indexOf('T'))} 23:59:59'`
