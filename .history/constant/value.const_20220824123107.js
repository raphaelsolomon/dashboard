...
exports.COMMODITY_HEADER = [
    'ID', 'Purchased Date', 'Purchased Cost', 'Customer Name', 'Phone Number', 'Commodity', 'Commodity Size', 'Commodity Color',
    'Sales Date', 'Sales Cost', 'Delivery Street', 'Purchasing Gender', 'Mode of Payment', 'Delivery Location', 'Mode of Transaction',
    'Advertising Medium', 'Status'
];
...
exports.COMMODITY_ATTRIBUTE = [
    ...
    'sales_cost', 'delivery_street', 'purchasing_gender', 'mode_payment', 'delivery_location', 'mode_transaction', 'advertising_medium',
    'status'
];

exports.VALIDATE = [check("email", "Email is not valid").isEmail().normalizeEmail(),
check("phone_number", "Phone Number is not valid")
