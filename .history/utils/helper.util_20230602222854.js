...
exports.payloadAudit = (req, data) => {
    ...
    payload['first_safety'] = {
        free_obstruction: data.Statutory_Compliancefree_obstruction,
        fire_extinguishers_hung_wall: data.Statutory_Compliancefire_extinguishers_hung_wall,
        other_fire_fighting_equipment_installed: data.Statutory_Complianceother_fire_fighting_equipment_installed,
        fire_service_certificate: data.Statutory_Compliancefire_service_certificate,
        fire_equipment: data.Statutory_Compliancefire_equipment,
        classes_fire_extinguishers: data.Statutory_Complianceclasses_fire_extinguishers,
        fire_extinguishers_present: data.Statutory_Compliancefire_extinguishers_present,
        where_fire_extinguisher_obstructed: data.Statutory_Compliancewhere_fire_extinguisher_obstructed,
        where_placed_floor: data.Statutory_Compliancewhere_placed_floor,
        fire_extinguishers_serviced_last: data.Statutory_Compliancefire_extinguishers_serviced_last,
        expiring_date_fire_extinguishers: data.Statutory_Complianceexpiring_date_fire_extinguishers,
        section: 'Statutory_Compliance',
        userId: req.user.id
    };
    payload['first_aid'] = {
