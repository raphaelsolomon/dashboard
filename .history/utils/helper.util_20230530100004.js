...
exports.payloadAudit = (req) => {
    ...
    payload['floors'] = {
        are_gang_way_free_from_obs: req.body['Environment[floors][are_gang_way_free_from_obs]'],
        are_gang_way_free_from_obs_where: req.body['Environment[floors][are_gang_way_free_from_obs_where]'],
        section: 'environment',
        userId: req.user.id 
    }
