...
exports.payloadAudit = (req, data) => {
    ...
    payload['control_substance'] = {
        harmful_sub_stored_in_facility: data.Statutory_Compliance.hazardous_to_health  === undefined ? '' :.harmful_sub_stored_in_facility,
        cleaning_item_stored_safely_within: data.Statutory_Compliance.hazardous_to_health  === undefined ? '' :.cleaning_item_stored_safely_within,
        did_cleaner_use_personal_protective_equip: data.Statutory_Compliance.hazardous_to_health  === undefined ? '' :.did_cleaner_use_personal_protective_equip,
        generator_free_of_oil_spillage: data.Statutory_Compliance.hazardous_to_health  === undefined ? '' :.generator_free_of_oil_spillage,
        fucmigation_conducted: data.Statutory_Compliance.hazardous_to_health  === undefined ? '' :.fucmigation_conducted,
        section: 'Statutory_Compliance',
        userId: req.user.id
    };
