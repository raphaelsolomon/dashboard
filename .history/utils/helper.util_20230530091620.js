...
exports.payloadAudit = (req) => {
    ...
    payload['access_exit'] = {
        ...
        access_door_free_from_obs: req.body['Environment[access_exit][access_door_free_from_obs]'],access_door_free_from_obs: req.body['Environment[access_exit][access_door_free_from_obs]'],
    }
     //=======================================IMAGES================================
     payload['images'] = {
