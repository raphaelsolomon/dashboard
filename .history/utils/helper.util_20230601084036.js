...
exports.payloadAudit = (req) => {
    ...
    payload['control_substance'] = {
        issued_first_aid_treatment: req.body['Statutory_Compliance[hazardous_to_health][issued_first-harmful_sub_stored_in_facility]'],
        other_first_aid_equipment: req.body['Statutory_Compliance[hazardous_to_health][other_first-aid_equipment]'],
