...
exports.payloadAudit = (req) => {
    ...
    //=======================================ENVIRONMENTS===========================
    payload['gangways'] = {
        are_gang_way_free_from_obs: req.body['Environment[gangways][are_gang_way_free_from_obs]'],
        are_gang_way_free_from_obs_where: req.body['Environment[gangways][are_gang_way_free_from_obs_where]'],
        are_gang_way_properly_lit: req.body['Environment[gangways][are_gang_way_properly_lit]'],
        are_gang_way_properly_lit_where: req.body['Environment[gangways][are_gang_way_properly_lit_where]'],
        wide_enough_to_accomodate_flow_of_humans: req.body['Environment[gangways][wide_enough_to_accomodate_flow_of_humans]'],
        wide_enough_to_accomodate_flow_of_humans_where: req.body['Environment[gangways][wide_enough_to_accomodate_flow_of_humans_where]'],
        section: 'environment',
        userId: req.user.id 
    }
    payload['floors'] = {
        are_all_floors_even: req.body['Environment[floors][are_all_floors_even]'],
        did_you_sight_crack: req.body['Environment[floors][did_you_sight_crack]'],
        did_you_sight_crack_where: req.body['Environment[floors][did_you_sight_crack_where]'],
        section: 'environment',
        userId: req.user.id 
    }
    payload['lightening'] = {
        clear_and_visible_lightening_for_workers: req.body['Environment[lighting_general][clear_and_visible_lightening_for_workers]'],
        room_for_natural_lightening: req.body['Environment[lighting_general][room_for_natural_lightening]'],
        sight_faulty_bulbs: req.body['Environment[lighting_general][sight_faulty_bulbs]'],
        sight_faulty_bulbs_where: req.body['Environment[lighting_general][sight_faulty_bulbs_where]'],
        section: 'environment',
        userId: req.user.id 
    }
    payload['housekeeping'] = {
        general_house_keeping_of_the_bank: req.body['Environment[Housekeeping][general_house_keeping_of_the_bank]'],
        general_house_keeping_of_the_bank_where: req.body['Environment[Housekeeping][general_house_keeping_of_the_bank_where]'],
        items_stored_securely_in_right_place: req.body['Environment[Housekeeping][items_stored_securely_in_right_place]'],
        items_stored_securely_in_right_place_where: req.body['Environment[Housekeeping][items_stored_securely_in_right_place_where]'],
        signs_of_trailing_cable: req.body['Environment[Housekeeping][signs_of_trailing_cable]'],
        signs_of_trailing_cable_where: req.body['Environment[Housekeeping][signs_of_trailing_cable_where]'],
        other_comment: req.body['Environment[Housekeeping][other_comment]'],
        section: 'environment',
        userId: req.user.id 
    }
    ...
    payload['stairs_staircases'] = {
        are_all_guardrails_present: req.body['Environment[stairs_staircases][are_all_guardrails_present]'],
        did_you_sight_any_faulty_guardrails: req.body['Environment[stairs_staircases][did_you_sight_any_faulty_guardrails]'],
        did_you_sight_any_faulty_guardrails_where: req.body['Environment[stairs_staircases][did_you_sight_any_faulty_guardrails_where]'],
        section: 'environment',
        userId: req.user.id 
    }
    payload['safety_signs'] = {
        installed_in_strategic_locations: req.body['Environment[safety_signs][installed_in_strategic_locations]'],
        signs_in_their_right_color_code: req.body['Environment[safety_signs][signs_in_their_right_color_code]'],
        are_there_any_sign_faded: req.body['Environment[safety_signs][are_there_any_sign_faded]'],
        section: 'environment',
        userId: req.user.id 
    }
    payload['temperature'] = {
    ...
    payload['access_exit'] = {
        ...
        are_safety_sign_placed_at_exit_door: req.body['Environment[access_exit][are_safety_sign_placed_at_exit_door]'],
        section: 'environment',
        userId: req.user.id 
    }
     //=======================================IMAGES================================
    ...
    payload['control_substance'] = {
        harmful_sub_stored_in_facility: req.body['Statutory_Compliance[hazardous_to_health][harmful_sub_stored_in_facility]'],
        cleaning_item_stored_safely_within: req.body['Statutory_Compliance[hazardous_to_health][cleaning_item_stored_safely_within]'],
        did_cleaner_use_personal_protective_equip: req.body['Statutory_Compliance[hazardous_to_health][did_cleaner_use_personal_protective_equip]'],
        generator_free_of_oil_spillage: req.body['Statutory_Compliance[hazardous_to_health][generator_free_of_oil_spillage]'],
        fucmigation_conductedfucmigation_conducted: req.body['Statutory_Compliance[hazardous_to_health][fucmigation_conducted]'],
        section: 'Statutory_Compliance',
        userId: req.user.id 
    };

    payload['display_monitor'] = {
        monitor_screens_brightness_moderate: req.body['Statutory_Compliance[display_screen_equipment][monitor_screens_brightness_moderate]'],
        yes_how_frequently: req.body['Statutory_Compliance[display_screen_equipment][yes_how_frequently]'],
        eye_checks_conducted: req.body['Statutory_Compliance[display_screen_equipment][eye_checks_conducted]'],
        section: 'Statutory_Compliance',
        userId: req.user.id 
    };
    ...
    payload['insurance'] = {
        ...
        when_paid_last_insurance: req.body['Administration_Procedure[Insurance][when_paid_last_insurance]'],
        section: 'administration_procedure',
        userId: req.user.id 
    };
    ...
    payload['training'] = {
        ...
        documented: req.body['Administration_Procedure[Training][documented]'],
