...
exports.getEdit = async (req, res, next) => {
  ...
  return res.status(200).render("../commodity/edit", { user: req.user, notification: notification, commodity, title: 'Edit Record' });
}
...
exports.update = async (req, res, next) => {
  ...
  return res.status(200).redirect(`/details?id=${commodity.id}`);
}