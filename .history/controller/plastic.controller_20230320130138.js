...
exports.plasticIndex = async (req, res, next) => {
  ...
  const totalCrushCapsWeight = await require('./../chartQuery/plastic.query').getTotalCrushCapsWeight();
  const totalSortsWeight = await require('./../chartQuery/plastic.query').getTotalSortsWeight();
  const flakesAnalysis = require('./../chartQuery/plastic.query').getCrushFlakesWithBarChart();
  //=================================PHASE TWO==============================================
