...
exports.getTotal = async (req, res) => {
    ...
    const plastic = await Plastic.findAll({ where: {},
        attributes: ['id', 'date', 'zone', 'retrieved_from', [sequelize.fn('COUNT', sequelize.col('retrieved_from')), 'total']],
        group: 'retrieved_from', order: [[sequelize.fn('COUNT', sequelize.col('customer_name')), 'DESC']]
    });
