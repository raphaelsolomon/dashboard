...
exports.getCharts = async (req, res, next) => {
  const result = await require('./../chartQuery/plastic.query').getCollectedPlasticsByMonths(req);
  const getVolumeOfPlastics = await require('./../chartQuery/plastic.query').getCollectedPlasticsByMonths(req);
  console.log(result);
