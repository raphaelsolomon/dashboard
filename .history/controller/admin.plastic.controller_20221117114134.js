...
exports.getTotal = async (req, res) => {
    const plastic = await Plastic.findAll({
        attributes: ['date', 'zone', 'retrieved_from', [sequelize.fn('COUNT', sequelize.col('retrieved_from')), 'total']],
        raw: true, order: [[sequelize.fn('COUNT', sequelize.col('retrieved_from')), 'DESC']]
    });
    console.log(plastic);
