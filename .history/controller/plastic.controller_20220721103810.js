...
exports.plasticIndex = async (req, res, next) => {
    ...
    var data = {
        ...
        totalRetrieveLocation: totalRetrieveLocation[0][0],
        daysWithHighestRetrieval: daysWithHighestRetrieval[0][0],
    ...
    return res.status(200).render('../plastics/index', { user: req.user, data: data, title: '' })
}
