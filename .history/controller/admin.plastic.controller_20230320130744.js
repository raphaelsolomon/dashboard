...
exports.getLabel = async (req, res) => {
    ...
    return res.status(200).render('../admin/plastics/sorting_label', { users: req.user, sort: sorting,  isUsed: true, });
}

exports.getColors = async (req, res) => {
    const sorting = await Sorting.findAll({
    });
    return res.status(200).render('../admin/plastics/sorting_color', { users: req.user, sort: sorting,  isUsed: true, });
}
