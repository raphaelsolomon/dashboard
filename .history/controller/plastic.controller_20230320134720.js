...
exports.plasticIndex = async (req, res, next) => {
  ...
  const flakesAnalysis = await require('./../chartQuery/plastic.query').getCrushFlakesWithBarChart();
  const capAnalysis = await require('./../chartQuery/plastic.query').getCrushFlakesWithBarChart();
  //=================================PHASE TWO==============================================
