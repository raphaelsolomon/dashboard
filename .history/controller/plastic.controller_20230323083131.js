...
exports.getEdit = async (req, res, next) => {
  ...
  return res.status(200).render("../plastics/edit", { user: req.user, notification: notification, plastic, title: 'Edit Plastics',  isUsed: false, });
...
exports.editSort = async (req, res, next) => {
  ...
  return res.status(200).render("../plastics/sort_edit", { user: req.user, notification: notification, data: data, title: 'Edit Sort', isUsed: false, });
}
