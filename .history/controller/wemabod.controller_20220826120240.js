...
exports.getEdit = async (req, res, next) => {
  ...
  const plastic = await Wemabod.findOne({where: {id: req.params.id}});
  return res.status(200).render("../wemabod/edit", {user: req.user, notification: notification, plastic, title: 'Edit Plastics'});
}
