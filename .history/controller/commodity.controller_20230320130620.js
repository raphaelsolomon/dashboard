...
exports.addItem = async (req, res, next) => {
  ...
  return res
    .status(200)
    .render("../commodities/add", { user: req.user, title: "Add Items", notification: notification,  isUsed: true, });
};
...
exports.getEdit = async (req, res, next) => {
  ...
  return res.status(200).render("../commodities/edit", { user: req.user, notification: notification, commodity, title: 'Edit Record',  isUsed: true, });
}
