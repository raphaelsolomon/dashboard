...
exports.index = async (req, res) => {
    const newUsers = await sequelize.query(`SELECT * FROM users where createdAt BETWEEN '${getPreviousDay(1).toISOString().substring(0, getPreviousDay().toISOString().indexOf('T'))} 00:00:00' AND '${2022-09-30} 23:59:59'`);
