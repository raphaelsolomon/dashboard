...
exports.index = async (req, res) => {
    ...
    return res.status(200).render('../admin/plastics/index', { users: users, newUsers: newUsers, active: Active.length, inactive: InActive.length, total: usersComplete.length });
}
