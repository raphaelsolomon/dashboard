...
exports.getCaps = async (req, res) => {
    ...
    return res.status(200).render('../admin/plastics/sorting_caps', { users: req.user, sort: sorting });
}
...
exports.getColors = async (req, res) => {
    return res.status(200).render('../admin/plastics/', { users: req.user, plastic: {} });
}
