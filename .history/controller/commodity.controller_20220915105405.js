...
exports.commodityIndex = async (req, res, next) => {
  ...
  const mostSold = await sequelize.query(`SELECT commodity, COUNT(*) AS magnitude FROM commodities WHERE userId=8 GROUP BY commodity ORDER BY magnitude DESC LIMIT 1`);
