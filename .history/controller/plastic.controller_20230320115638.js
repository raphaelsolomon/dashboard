...
exports.plasticIndex = async (req, res, next) => {
  ...
  const totalCrushWeight = await require('./../chartQuery/plastic.query').getTotalCrushWeight();
  const totalCrushFlakeshWeight = await require('./../chartQuery/plastic.query').getTotalCrushFlakesWeight();
  const totalCrushCapshWeight = await require('./../chartQuery/plastic.query').getTotalCrushCapsWeight();
  const totalCrushCapshWeight = await require('./../chartQuery/plastic.query').getTotalSortsWeight();
  //=================================PHASE TWO==============================================
  ...
  return res.status(200).render("../plastics/index", {
    ...
    totalCrushCapshWeight: totalCrushCapshWeight,
    //========================================
...
exports.editSort = async (req, res, next) => {
  ...
  return res.status(200).render("../plastics/sort_edit", { user: req.user, notification: notification, data: data, title: 'Edit Sort' });
}
