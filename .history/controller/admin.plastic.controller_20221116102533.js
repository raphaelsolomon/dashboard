...
exports.index = async (req, res) => {
    ...
    return res.status(200).render('../admin/plastics/index', { users: req.user, plastic: plastic, highestLocation: highestLocation, highestLocationByDate: highestLocationByDate });
}
