...
exports.commodityIndex = async (req, res, next) => {
  ...
  var data = {
    ...
    mostSold: mostSold[0][0].commodity === undefined ? '' : mostSold[0][0].commodity,
    advertMedium: advertMedium[0][0].advertising_medium === undefined ? '' : advertMedium[0][0].advertising_medium
  };
