...
exports.getEdit = async (req, res, next) => {
  ...
  return res.status(200).render("../plastics/edit", {user: req.user, notification: notification, logistic, title: 'Edit Plastics'});
}
...
exports.update = async (req, res, next) => {
  ...
  await logistic.save();
  return res.status(200).redirect(`/details/${logistic.id}`);
}