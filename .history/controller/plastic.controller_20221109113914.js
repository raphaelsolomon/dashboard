...
exports.getCharts = async (req, res, next) => {
  ...
  const initialContentByVolumn = await require('./../chartQuery/plastic.query').initialContentByVolumn(req);
  console.log(initialContentByVolumn);
  ...
  return res
    ...
    .render("../plastics/chart", {
      ...
      initialContentByVolume: initialContentByVolumn
      notification: notification
    });
};
