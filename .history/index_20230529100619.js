...
User.hasMany(AuditLiftOpt)
User.hasMany(AuditReportInjuries)
User.hasMany(AuditControlSubstance)
...
AuditLiftOpt.belongsTo(User, { constraints: true, onDelete: "CASCADE" });
