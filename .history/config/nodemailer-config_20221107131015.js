    ...
    html: `<!doctype html>
      <html>
        ...
        <body>
          ...
          P.S: Kindly note you don't have any analysis currently. The analysis will be ready after you have inputted your sales data</h2>
        </body>
      </html>`, // plain text body
  }, function (err) {
    if (err) {
