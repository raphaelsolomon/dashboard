...
exports.sendRegisterLink = (user) => {
  ...
  return transporter.sendMail({
    ...
    subject: `Registration Update`, // Subject line
    html: `<!doctype html>
      <html>
        <head>
          <meta charset="utf-8">
...
exports.sendWelcomeLink = (user) => {
  ...
  transporter.sendMail({
    ...
    subject: `Welcome to dechdash`, // Subject line
    html: `<!doctype html>
      <html>
        <head>
          <meta charset="utf-8">
        ...
        <body>
          <p>Image: <amp-img src="https://cldup.com/P0b1bUmEet.png" width="16" height="16"/></p>
          <h3>Welcome to Dech Dashboard,</h3><br>
          <p>Dear ${user.business_name},
          Thank you for choosing our ${user.trade} Dashboard for analyzing your business data
          Proceed to log in to get started
          Click here to <a href="https://dechdash.net"> Log In </a><br><br>
          What Next<br><br>
          Kindly proceed to input your data by clicking on “Add Data”<br><br>
          Fill in your sales data and click on "Add data" at the bottom to save that information.
          Repeat the process for all your daily sales data.<br><br>
          P.S: Kindly note you don't have any analysis currently. The analysis will be ready after you have inputted your sales data</p><br><br>
          <h4>Regards</h4>
        </body>
      </html>`, // plain text body
  }, function (err) {
