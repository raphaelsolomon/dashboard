(function ($) {
    ...
    form.children("div").steps({
        ...
        onFinished: function (event, currentIndex) {
            ...
            var course_study = $('#course_studied').find(":selected").val();
...
function em_other(value) {
    if (value === 4) {
        document.getElementById("#em_status_other").style.display = 'block';
    } else {
        document.getElementById("#em_status_other").style.display = 'none';
    }
}

function ed_other(value) {
    if (value === 6) {
        document.getElementById("#ed_level_other").style.display = 'block';
    } else {
        document.getElementById("#ed_level_other").style.display = 'none';
    }
}
function fd_other(value) {
    if (value === 21) {
        document.getElementById("#fd_expertise_other").style.display = 'block';
    } else {
        document.getElementById("#fd_expertise_other").style.display = 'none';
    }
}
function cs_other(value) {
    if (value === 615) {
        document.getElementById("#course_study_other").style.display = 'block';
    } else {
        document.getElementById("#course_study_other").style.display = 'none';
    }
}
