(function ($) {
    ...
    form.children("div").steps({
        ...
        onFinished: function (event, currentIndex) {
            ...
            var emp_status = $('#emp_status').find(":selected").val() === '' ? $("#em_status_other").val() : 
            var emp_qualification = $('#emp_qualification').find(":selected").val() === '' ? :  $('#emp_qualification').find(":selected").val();
