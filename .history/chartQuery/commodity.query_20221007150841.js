...
exports.getmostAdvertising = async (req) => {
    ...
    const commodity = await Commodity.findAll({where: {id: req.user.id}, attributes: [[sequelize.fn('COUNT', sequelize.col('advertising_medium')), 'magnitude'], ['advertising_medium', 'advertising_medium']], group: 'advertising_medium', order: ['']})
