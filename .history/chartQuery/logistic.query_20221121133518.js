...
exports.highestModeOfTransaction = async (req, res) => {
    return await Logistics.findAll({
        attributes: ['mode_of_pay', [sequelize.fn('COUNT', sequelize.col('itemToBeDelivered')), 'total']],
        raw: true,
        group: 'mode_of_pay', order: [[sequelize.fn('COUNT', sequelize.col('itemToBeDelivered')), 'DESC']]
    });
}
