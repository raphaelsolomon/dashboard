...
exports.firstPage = async (req, res) => {
    const getTotalPedestrian = await Wemabod.findAll({
        ...
        attributes: [
            ...
            [sequelize.fn('SUM', sequelize.col('man_matters')), 'vehicle5'],
            [sequelize.fn('SUM', sequelize.col('hospital_matters')), 'vehicle5'],
        ],
        where: {}
    });
    ...
    const others = Number.parseInt(getTotalPedestrian[0].police) + Number.parseInt(getTotalPedestrian[0].
    return { pedestrians: pedTotal, vehicles: vehTotal, visitors: visTotal };
}