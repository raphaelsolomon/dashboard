...
exports.topPickUpsDelivered = async (req, res) => {
    return await Logistics.findAll({
        attributes: ['pickupaddress_area', [sequelize.fn('COUNT', sequelize.col('c_deliveryAddress_str')), 'total']],
        raw: true,
        group: 'pickupaddress_area', order: [[sequelize.fn('COUNT', sequelize.col('c_deliveryAddress_str')), 'DESC']]
    });
}