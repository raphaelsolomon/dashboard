...
exports.firstPage = async (req, res) => {
    ...
    const nfs = Number.parseInt(getTotalPedestrian[0].hospital);
    return { pedestrians: pedTotal, vehicles: vehTotal, visitors: visTotal, others: others, staffs: staffTotals, residents: resTotal, hospitals: hospital, npfs: np};
}