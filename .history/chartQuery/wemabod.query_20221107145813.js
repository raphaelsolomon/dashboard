...
exports.firstPage = async (req, res) => {
    ...
    const resTotal = Number.parseInt(getTotalPedestrian[0].
    return { pedestrians: pedTotal, vehicles: vehTotal, visitors: visTotal, others: others, staffs: staffTotals, residents:  };
}