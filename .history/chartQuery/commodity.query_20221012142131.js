...
exports.getTotalProfit = async (req) => {
    ...
    commodity.forEach((c) => { 
        console.log(Number.parseInt(`${c.dataValues.purchased_cost}`.replace(/,/g, '')).toFixed(2));
        //total = total + Number.parseInt(`${c.dataValues.purchased_cost}`.replace(/,/g, '')).toFixed(2)
    });
