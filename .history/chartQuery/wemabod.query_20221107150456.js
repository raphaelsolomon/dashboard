...
exports.firstPage = async (req, res) => {
    ...
    const man = Number.parseInt(getTotalPedestrian[0].police);
    return { pedestrians: pedTotal, vehicles: vehTotal, visitors: visTotal, others: others, staffs: staffTotals, residents: resTotal, hospitals: hospital, npfs: nfs};
}