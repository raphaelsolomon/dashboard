...
exports.firstPage = async (req, res) => {
    ...
    const visTotal = Number.parseInt(getTotalPedestrian[0].ped1) + Number.parseInt(getTotalPedestrian[0].ped2) + Number.parseInt(getTotalPedestrian[0].ped3);
    return { pedestrians: pedTotal, vehicles: vehTotal, visitors: visitors };
}