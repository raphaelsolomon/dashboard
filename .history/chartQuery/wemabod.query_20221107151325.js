...
exports.firstPage = async (req, res) => {
    ...
    return { pedestrians: pedTotal, vehicles: vehTotal, visitors: visTotal, others: others, staffs: staffTotals, residents: resTotal, hospitals: hospital, npfs: nfs, man_center: man, adeojo:ade };
}