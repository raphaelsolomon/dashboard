...
exports.firstPage = async (req, res) => {
    ...
    const staffTotals = Number.parseInt(getTotalPedestrian[0].vehicle2) + Number.parseInt(getTotalPedestrian[0].man) + Number.parseInt(getTotalPedestrian[0].hospital);
