...
exports.firstPage = async (req, res) => {
    ...
    const vehTotal = Number.parseInt(getTotalPedestrian[0].vehicle1) + Number.parseInt(getTotalPedestrian[0].vehicle2) + Number.parseInt(getTotalPedestrian[0].vehicle3) + Number.parseInt(getTotalPedestrian[0].vehicle2) + Number.parseInt(getTotalPedestrian[0].vehicle3);
