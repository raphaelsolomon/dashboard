...
exports.getmostAdvertising = async (req) => {
    ...
    commodity = await req.user.getCommodities({
        where: {},
        attributes: ['flakes', [sequelize.fn('COUNT', sequelize.col('advertising_medium')), 'total']],
        group: 'flakes', order: [[sequelize.fn('COUNT', sequelize.col('advertising_medium')), 'DESC']]
    });
