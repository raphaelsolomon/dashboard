...
const { AuditAccessExits, AuditGangWays, AuditFloors, AuditHouseKeeping, AuditLightenings, AuditFirePrecautions, AuditStairCases, AuditSafetySigns, AuditTemperatures } = require('./model/audit/environment.model');
...
User.hasMany(AuditTraining.AuditTraining);
...
User.hasMany(AuditTraining.AuditPermitWork)
User.hasMany(AuditTraining.AuditSafetySystem)
User.hasMany(AuditTraining.AuditCommunication)
User.hasMany(AuditTraining.AuditContractorsMgt)
User.hasMany(AuditLiftOpt.AuditHandTools)
User.hasMany(AuditAccessExits);
User.hasMany(AuditFirePrecautions);
User.hasMany(AuditStairCases);
User.hasMany(AuditSafetySigns);
User.hasMany(AuditTemperatures);
User.hasMany(AuditGangWays)
User.hasMany(AuditFloors)
User.hasMany(AuditHouseKeeping)
User.hasMany(AuditLightenings)
...
AuditTraining.AuditTraining.belongsTo(User, { constraints: true, onDelete: "CASCADE" });
...
AuditTraining.AuditSafetySystem.belongsTo(User, { constraints: true, onDelete: "CASCADE" });
AuditTraining.AuditCommunication.belongsTo(User, { constraints: true, onDelete: "CASCADE" });
AuditTraining.AuditContractorsMgt.belongsTo(User, { constraints: true, onDelete: "CASCADE" });
AuditLiftOpt.AuditHandTools.belongsTo(User, { constraints: true, onDelete: "CASCADE" });
AuditAccessExits.belongsTo(User, { constraints: true, onDelete: "CASCADE" });
AuditFirePrecautions.belongsTo(User, { constraints: true, onDelete: "CASCADE" });
AuditStairCases.belongsTo(User, { constraints: true, onDelete: "CASCADE" });
AuditSafetySigns.belongsTo(User, { constraints: true, onDelete: "CASCADE" });
AuditTemperatures.belongsTo(User, { constraints: true, onDelete: "CASCADE" });
AuditGangWays.belongsTo(User, { constraints: true, onDelete: "CASCADE" });
AuditFloors.belongsTo(User, { constraints: true, onDelete: "CASCADE" });
AuditHouseKeeping.belongsTo(User, { constraints: true, onDelete: "CASCADE" })
AuditLightenings.belongsTo(User, { constraints: true, onDelete: "CASCADE" })
